  ...
  return (
    <div className='relative'>
        ...
        <div className='absolute inset-0 p-20 flex gap-7 justify-center items-center flex-col w-full h-full z-[9999] text-secondaryColor bg-linearBackground'>
            <h1 className='textshadow text-2xl md:text-5xl font-bold text-whiteColor text-shadow-md text-center'> <span className='text-secondaryColor'>Book</span> Your Laundry Services <br /> Hassle Free</h1>
            <p className='text-whiteColor hidden md:block text-center'>We offer affordable pricing options so that you can spend more time doing the things you love,<br></br> and less time worrying about laundry</p>
