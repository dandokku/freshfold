            ...
            >
                ...
                <SwiperSlide className='relative'>
                    ...
                    <div className='absolute inset-0 p-20 flex gap-7 justify-center items-center flex-col w-full h-full z-[9999] text-secondaryColor bg-linearBackground'>
                        <h1 className='textshadow text-5xl sm:text-xl font-bold text-whiteColor text-shadow-md text-center'> <span className='text-secondaryColor'>Book</span> Your Laundry Services <br /> Hassle Free</h1>
